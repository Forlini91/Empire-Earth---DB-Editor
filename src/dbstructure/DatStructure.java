...
public enum DatStructure {
	...
	DB_OBJECT ("dbobjects.dat", 0, true, 0, 1, 5, -1, null,
			...
			new EntryStruct("Object ID", Type.INTEGER, 4, false, EntryStruct.ID_COLOR), new EntryStruct("Health", Type.INTEGER, 4), EntryStruct.UNKNOWN_INT4, new EntryStruct("Min range", Type.FLOAT, 4),
			...
			EntryStruct.UNKNOWN_INT4, EntryStruct.UNKNOWN_INT4, new EntryStruct("Flight time", Type.INTEGER, 4), EntryStruct.UNKNOWN_INT4,
			...
			EntryStruct.UNKNOWN_INT4, new EntryStruct("Graphic size", Type.FLOAT, 4), new EntryStruct("Unit type", Type.STRING, 24), EntryStruct.UNKNOWN_INT4,
			EntryStruct.UNCHANGED_INT4, new EntryStruct("Button ID", Type.INTEGER, 4), new EntryStruct("Graphic ID", Type.INTEGER, 4), new EntryStruct("", Type.INTEGER, 4), new EntryStruct("Build rate", Type.FLOAT, 4),
			...
			new EntryStruct("Action button 7", Type.INTEGER, 4), new EntryStruct("Action button 8", Type.INTEGER, 4), new EntryStruct("Action button 9", Type.INTEGER, 4), EntryStruct.UNKNOWN_INT4,
			new EntryStruct("Square occupied", Type.INTEGER, 4), new EntryStruct("Resource type", Type.INTEGER, 4), new EntryStruct("Resource amount", Type.INTEGER, 4), new EntryStruct("", Type.INTEGER, 4), new EntryStruct("Always face camera", Type.INTEGER, 4),
			...
			new EntryStruct("Show area effect stat"), new EntryStruct("Show repair stat", EntryStruct.UNUSED_COLOR), new EntryStruct("Show shock armor stat"), new EntryStruct("Show pierce armor stat"),
			...
			new EntryStruct("Show range"), new EntryStruct("Morale bonus", Type.INTEGER, 4), EntryStruct.UNKNOWN_INT4,
			EntryStruct.UNKNOWN_INT1, EntryStruct.UNKNOWN_INT4, EntryStruct.UNKNOWN_INT1, EntryStruct.UNKNOWN_INT4, EntryStruct.UNKNOWN_INT1, EntryStruct.UNKNOWN_INT4, EntryStruct.UNKNOWN_INT1,
			EntryStruct.UNKNOWN_INT4, new EntryStruct("Flight altitude", Type.INTEGER, 4), new EntryStruct("Language ID", Type.INTEGER, 4), EntryStruct.UNKNOWN_INT4, EntryStruct.UNCHANGED_INT4,
			new EntryStruct("Health regeneration", Type.INTEGER, 4), new EntryStruct("Can garrison in air transports"), new EntryStruct("Can garrison in land transports"), new EntryStruct("Can garrison in sea transports"), EntryStruct.UNKNOWN_INT1,
			new EntryStruct("Circle selection size", Type.FLOAT, 4), new EntryStruct("Shadow size", Type.FLOAT, 4),  EntryStruct.UNKNOWN_INT4, EntryStruct.UNKNOWN_INT4,
			new EntryStruct("Physical size", Type.FLOAT, 4), new EntryStruct("Unis can walk above this"), EntryStruct.UNKNOWN_INT1, EntryStruct.UNKNOWN_INT1, new EntryStruct("Proiettile trajectory is parabolic"), EntryStruct.UNKNOWN_INT4, EntryStruct.UNKNOWN_INT4,
			new EntryStruct("Ammo amount", Type.INTEGER, 4), EntryStruct.UNKNOWN_INT1, EntryStruct.UNKNOWN_INT1, EntryStruct.UNKNOWN_INT1, EntryStruct.UNKNOWN_INT1, EntryStruct.UNKNOWN_INT4, EntryStruct.UNKNOWN_INT4,
			...
			EntryStruct.UNKNOWN_INT4, new EntryStruct("Upgrade ID", Type.INTEGER, 4), EntryStruct.UNKNOWN_INT4, EntryStruct.UNKNOWN_FLOAT,
			new EntryStruct("Show in scenari editor"), EntryStruct.UNKNOWN_INT1, EntryStruct.UNKNOWN_INT1, EntryStruct.UNKNOWN_INT1, new EntryStruct("Can be killed with Delete"), EntryStruct.UNKNOWN_INT1, EntryStruct.UNKNOWN_INT1, EntryStruct.UNKNOWN_INT1, new EntryStruct("Low health effect ID", Type.INTEGER, 4), new EntryStruct("Death effect ID", Type.INTEGER, 4),
			...
			new EntryStruct("Permanent effect", Type.INTEGER, 4), EntryStruct.UNKNOWN_INT4, new EntryStruct("Projectile effect", Type.INTEGER, 4), EntryStruct.UNKNOWN_INT4,
			EntryStruct.UNKNOWN_INT4, EntryStruct.UNKNOWN_INT4, EntryStruct.UNKNOWN_INT4, EntryStruct.UNKNOWN_INT4,
			EntryStruct.UNKNOWN_INT4, EntryStruct.UNKNOWN_INT4, new EntryStruct("Attack effect ID", Type.INTEGER, 4), EntryStruct.UNKNOWN_INT4,
			EntryStruct.UNKNOWN_INT4, EntryStruct.UNKNOWN_INT4, EntryStruct.UNKNOWN_INT4, EntryStruct.UNKNOWN_INT4,
			EntryStruct.UNKNOWN_INT4, EntryStruct.UNKNOWN_INT4, EntryStruct.UNKNOWN_INT4, EntryStruct.UNKNOWN_INT4,
			EntryStruct.UNKNOWN_INT4, EntryStruct.UNKNOWN_INT4, EntryStruct.UNKNOWN_INT4, EntryStruct.UNKNOWN_INT4,
			EntryStruct.UNKNOWN_INT4, EntryStruct.UNKNOWN_INT4, new EntryStruct("Terrain: Grass, Snow"), new EntryStruct("Elevation: Deep water"),
			new EntryStruct("Terrain: Rock, Stones and Artificial"), EntryStruct.UNKNOWN_INT1, EntryStruct.UNKNOWN_INT1, EntryStruct.UNKNOWN_INT1, EntryStruct.UNKNOWN_INT1, EntryStruct.UNKNOWN_INT1,
			EntryStruct.UNKNOWN_INT1, EntryStruct.UNKNOWN_INT1, new EntryStruct("Asphalt"), new EntryStruct("Elevation: cliffs"), new EntryStruct("Elevation: Shallow water"), EntryStruct.UNKNOWN_INT1, new EntryStruct("Terrain: Sand"), new EntryStruct("Terrain: Space"),
			EntryStruct.UNKNOWN_INT1, EntryStruct.UNKNOWN_INT1, EntryStruct.UNKNOWN_INT1, EntryStruct.UNKNOWN_INT1, new EntryStruct("Area Effect ID 1", Type.INTEGER, 4),
			...
			EntryStruct.UNKNOWN_INT4, EntryStruct.UNKNOWN_INT4, new EntryStruct("Carry capacity", Type.INTEGER, 4), EntryStruct.UNKNOWN_INT4,
			EntryStruct.UNKNOWN_INT4, EntryStruct.UNKNOWN_INT1, EntryStruct.UNKNOWN_INT1, EntryStruct.UNKNOWN_INT1, EntryStruct.UNKNOWN_INT1, EntryStruct.UNKNOWN_INT4, EntryStruct.UNKNOWN_INT4,
			...
			new EntryStruct ("Plane build mode"), EntryStruct.UNKNOWN_INT4, EntryStruct.UNKNOWN_INT4, EntryStruct.UNKNOWN_INT4


			),
	//EntryStruct.UNKNOWN_INT4
	//new EntryStruct("", Type.INTEGER, 4)
	//new EntryStruct("", Type.FLOAT, 4)
	//new EntryStruct("")
	
	DB_TECH_TREE("dbtechtree.dat", 1, true, 0, 1, 2, 46, new EntryStruct("Tech builder", Type.INTEGER, 4),
			EntryStruct.NAME, EntryStruct.SEQ_NUMBER,
			...
			EntryStruct.UNKNOWN_FLOAT, EntryStruct.UNKNOWN_FLOAT, EntryStruct.UNKNOWN_FLOAT, EntryStruct.UNKNOWN_INT1, new EntryStruct("Only in scenario"), EntryStruct.UNKNOWN_INT1, EntryStruct.UNKNOWN_INT1,
	...
	DB_AREA_EFFECT("dbareaeffect.dat", 0, true, 0, 1, 2, -1, null,
			EntryStruct.NAME, EntryStruct.SEQ_NUMBER, new EntryStruct("Area Effect ID", Type.INTEGER, 4, false, EntryStruct.ID_COLOR), new EntryStruct("Effect type", Type.INTEGER, 4),
			EntryStruct.UNKNOWN_INT4, EntryStruct.UNKNOWN_INT4, EntryStruct.UNKNOWN_INT4, EntryStruct.UNKNOWN_INT4,
	...
	DB_BUTTONS ("dbbuttons.dat", 0, true, 0, 2, 3, -1, null,
			EntryStruct.NAME, new EntryStruct("Texture", Type.STRING, 100), EntryStruct.SEQ_NUMBER,
	...
	DB_STARTING_RESOURCHES ("dbstartingresources.dat", 0, true, 0, 1, 2, -1, null,
			EntryStruct.NAME, EntryStruct.SEQ_NUMBER, new EntryStruct("Starting Resourches ID", Type.INTEGER, 4, false, EntryStruct.ID_COLOR),
	...
	DB_MUSIC ("dbmusic.dat", 0, true, 2, 0, 1, -1, null,
			EntryStruct.SEQ_NUMBER, new EntryStruct("Music ID", Type.INTEGER, 4), EntryStruct.NAME,
	...
	DB_UIHOTKEY ("dbuihotkey.dat", 0, true, 2, 0, 1, -1, null,
			EntryStruct.SEQ_NUMBER, new EntryStruct("Hotkey ID", Type.INTEGER, 4, false, EntryStruct.ID_COLOR),
