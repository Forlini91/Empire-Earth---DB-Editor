...
public enum ObjectType implements EnumValue {
	...
	public ObjectType parseValue (int code) {
		switch (code) {
			case 0:
				return C0_Buildings_World;
			case 1:
				return C1_Aircrafts;
			case 2:
				return C2_Heroes_Medics;
			case 3:
				return C3_Archers;
			case 4:
				return C4_Siege_AATowers;
			case 5:
				return C5_Infantry_Cyborgs;
			case 6:
				return C6_Priests_Prophets;
			case 7:
				return C7_Citizens_Diplomats;
			case 8:
				return C8_Cavalry_Tanks;
			case 9:
				return C9_Ships_Submarines;
			default:
				return null;
		}
	}
